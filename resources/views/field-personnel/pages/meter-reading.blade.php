    ...
    <div class="mt-3" id="reading">
        <div class="row">
            <div class="col-12 col-sm-8 col-md-6 col-lg-6 form-search hidden pt-1">
                <form action="{{ route('admin.reader.search') }}" method="get" class="d-flex justify-content-between align-items-center mb-lg-0">
                    <input type="text" class="form-control" name="account_number" placeholder="Account #">
        ...
        <div class="row">
            <div class="col-12 col-sm-8 col-md-6">
                ...
                <h6 class="text-secondary ps-1 d-block d-lg-none" style="font-size: 15px !important;"><strong>ACCOUNT NO : <span class="text-primary" id="customer_account">{{ isset($customer) ? $customer["account"] : '' }}</span></strong></h6>
...
>>>>>>> 59963f5157dd64efaef79afd11f664d61736ecc4
                        </tr>
                        -<tr>
